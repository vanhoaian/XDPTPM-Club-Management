...
import Spinner from "../ui/Spinner"; // Đảm bảo bạn đã nhập đúng đường dẫn tới component Spinner
...
const SinglePost = () => {
  ...
  const userData = JSON.parse(localStorage.getItem("userData")) || { likedPostIds: [], savedPostIds: [] };
  ...
  useEffect(() => {
    ...
    */
    ...
    const mockClubPost = {
      ...
      description: "This is a mock description for the post.",
      coordinators: [
  ...
  return (
    <CardContainer>
      ...
      <Actions>
        {user.role === "user" && (
          <ActionButton onClick={() => setLike(!isliked)}>
