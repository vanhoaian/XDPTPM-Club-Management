...
const Attend = () => {
  ...
  return (
    <div>
      ...
      <InfoContainer>
        <InfoItem>Tổng buổi nghỉ trong tháng:</InfoItem>
        <InfoItem>Tổng buổi đến muộn trong tháng:</InfoItem>
        <InfoItem>Tổng buổi nghỉ không phép trong tháng:</InfoItem>
        <InfoItem>Tổng buổi đến muộn không phép trong tháng:</InfoItem>
        <InfoItem>Cảnh báo:</InfoItem>
      </InfoContainer>
      <Table>
        <thead>
          <tr>
